...
<style>
  ...
  @media (max-width: 720px) {
    ...
    .thesis-table-wrap { margin: 2rem -1.25rem; padding: 0 1.25rem; }
  }
</style>
...
There are ten essential physical requirements for any community to participate in economic life on its own terms. We call this the 949 framework:

**Food · Housing · Water · Energy · Transportation · Hygiene · Security · Police/Military · Telecommunications · Clothing**

These are not aspirational categories. They are the minimum. Without sovereign access to each of them, a community operates at the mercy of whoever controls the supply. With sovereign access, the incentive structure for coercion disappears. Peace becomes structurally favorable.

The 949 is the investment universe. Everything EvoBioSys Capital does serves one or more of these essentials.
...
Every investment decision passes through a three-layer filter:

**Good now.** Does this investment deliver value today, regardless of when or whether any transition happens? If yes, it is immediately viable and the risk is contained.

**Holds during transition.** Does this investment survive the phase shift — in climate, AI, migration, geopolitics — without requiring specific economic conditions to function? If it depends on a narrow Goldilocks scenario, it is fragile.

**Still valuable after.** Once the transition has occurred and a more regenerative economy is in place, does this investment retain its utility and value? If it becomes obsolete in the world we are building toward, it is a short-term bet, not a structural investment.

Food, housing, water, energy — these pass all three layers. That is why a thesis anchored in the 949 holds where trend-based theses don't have to: trends matter at the innovation layer, but the 949 is the floor under the trends.
...
**EvoBioSys Capital** deploys investment into 949-aligned ventures. The investment fund is separate from the commons network and from entity equity structures.
...
Each entity operates as a holon — a whole unto itself and a part of the larger whole. The commons network holds 51% of holon entities. A source keeper maintains the vision integrity. The architecture scales through composition, not centralized control.
...
| **Unit of analysis** | Individual asset or company | Individual investment with impact metrics | Interconnected portfolio targeting system dynamics | The 949 essentials — what every community needs regardless of system |
...
**Builders inside the 949** — farmers, Baumeister, retrofit teams, energy cooperatives, sovereign-cloud teams, water collectives, regenerative-agriculture teams — who want a stewardship-aligned coordination layer behind their work, not extraction in a softer wrapper.
